...
I chose for Kim, since it's an old song of eminem and can be seen as an outlier, since the song is critisized as going to far. Other songs i have tried where also more stable than this one, a possible explanation for this consistency could be the rap genre. Rap is often consistent in BPM, since the ruthm and beat is used to spit raps to, so clear lines where expected.
